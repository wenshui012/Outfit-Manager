...
export function injectStyles() {
    ...
    s.id = 'om-style-v4';
        s.textContent = [
            ...
            'border:2px solid rgba(255,152,0,.58);border-radius:10px;overflow:hidden;box-sizing:border-box;background:rgba(127,127,127,.04);}',
            ...
            'border:2px solid rgba(229,57,53,.45);object-fit:cover;flex-shrink:0;box-sizing:border-box;}',
            '.om-showcase-acc-ph{display:flex;align-items:center;justify-content:center;min-width:70px;height:100%;',
            'border-radius:8px;border:1px dashed rgba(127,127,127,.28);font-size:.72em;opacity:.62;',
