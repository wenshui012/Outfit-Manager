...
export function injectStyles() {
    ...
    s.id = 'om-style-v4';
        s.textContent = [
            ...
            '.om-kit-row{display:flex;align-items:center;gap:6px;flex-wrap:wrap;min-width:0;}',
            ...
            'color:#fff;padding:5px 10px;font-size:.75em;font-weight:700;font-family:inherit;cursor:pointer;}',
