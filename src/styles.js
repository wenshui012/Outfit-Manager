...
export function injectStyles() {
    ...
    s.id = 'om-style-v4';
        s.textContent = [
            ...
            'border:none;border-radius:10px;overflow:hidden;box-sizing:border-box;background:rgba(127,127,127,.04);}',
            ...
            'border:none;object-fit:cover;flex-shrink:0;box-sizing:border-box;}',
            '.om-showcase-acc-ph{display:flex;align-items:center;justify-content:center;min-width:70px;height:100%;',
            'border-radius:8px;border:none;background:rgba(127,127,127,.06);font-size:.72em;opacity:.62;',
